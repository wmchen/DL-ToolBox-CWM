...
from dl_toolbox_cwm.model.classification import ResNeXt50_32x4d
...
# model
model = ResNeXt50_32x4d(num_classes=10, pretrained='pretrained_model/ResNeXt/resnext50_32x4d.pth')
