...
from dl_toolbox_cwm.model.utils.build_layer import *
from dl_toolbox_cwm.model.utils.initialization import *
from dl_toolbox_cwm.model.utils.conv_module import ConvModule
from dl_toolbox_cwm.model.utils.core.parrots_wrapper import _BatchNorm
from dl_toolbox_cwm.model.backbone import BaseBackbone

__all__ = [
    'BasicBlock', 'Bottleneck', 'ResLayer',
    'ResNet', 'ResNet_Pretrain', 'ResNetV1d'
]
...
class ResNet_Pretrain(BaseBackbone):
    """ResNet backbone.
    ...
    def __init__(self,
        ...
        for i, num_blocks in enumerate(self.stage_blocks):
            ...
            _in_channels = _out_channels
            _out_channels *= 2
            layer_name = f'backbone.layer{i + 1}'
            self.add_module(layer_name, res_layer)
            self.res_layers.append(layer_name)
